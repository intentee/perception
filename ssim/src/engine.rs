...
pub enum Engine {
    #[cfg(feature = "cpu")]
    Cpu(Box<Ssim<ssim_backend_cpu::CpuBackend>>),
    #[cfg(feature = "cuda")]
    Cuda(Box<Ssim<ssim_backend_cuda::CudaBackend>>),
}
...
impl Engine {
    ...
    #[cfg(feature = "cuda")]
    pub fn cuda() -> Result<Self, ssim_backend_cuda::CudaError> {
        let backend = ssim_backend_cuda::CudaBackend::new()?;
